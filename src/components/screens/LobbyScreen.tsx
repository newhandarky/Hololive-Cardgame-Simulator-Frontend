...
import type { DeckSummary, LobbyMatch, LobbyPlayer } from '../../services/api';
    ...
    <>
      ...
      <section className="panel">
        ...
        <div className="row">
          ...
          />
          <Link className="button-link" to="/backgrounds/field">
            場地背景
          </Link>
          <Link className="button-link" to="/backgrounds/card">
            卡片背景
          </Link>
